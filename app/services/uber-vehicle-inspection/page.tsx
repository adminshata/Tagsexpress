// app/services/uber-vehicle-inspection/page.tsx
"use client";
...
export default function UberVehicleInspectionPage() {
  const whyItems = [
    {
      icon: Zap,
    ...
    },
    {
      ...
      desc: "All inspections performed by DMV-trained professionals with Uber certification.",
    },
    {
      icon: ClipboardList,
    ...
    },
    {
      ...
      desc: "Sedans, SUVs, hybrids, and electrics—all meet Uber’s inspection standards.",
    },
  ];

  const steps = [
    "Bring your vehicle and a valid driver’s license.",
    "Complete the Uber inspection form (we’ll provide it).",
  ...
  const formItems = [
    {
      label: "Uber Vehicle Inspection Form",
      icon: FileText,
      link: null,
    },
    {
  ...
  const related = [
    { title: "Lyft Vehicle Inspection", href: "/services/lyft-vehicle-inspection" },
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:   "Bring your Uber Inspection Form and your valid driver’s license.",
    },
    {
    ...
    },
    {
      ...
      answer:   "Your Uber sticker is valid for 12 months, until your next yearly check.",
    },
  ];
    ...
    <main className="bg-white text-black">
      ...
      <section className="bg-gradient-to-b from-red-600 to-red-400 text-white text-center py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl mb-6">
            Quick, certified inspections to get your car Uber-ready—same-day service in San Diego.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href="#uber-inspection-form"
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-12">
          Why Drivers Choose Our Uber Inspection
        </h2>
      ...
      <section className="bg-gray-100 py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg mb-4">
            A comprehensive safety check of lights, brakes, tires, glass, seat belts, mirrors, and more to meet Uber’s standards.
          </p>
          <h3 className="text-2xl font-semibold mb-4">
            When Do You Need It?
          </h3>
          <ul className="list-disc list-inside text-lg text-gray-700 space-y-2">
            <li>Your car is new to Uber and needs initial certification.</li>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-700">
            Most inspections finish in 10–15 minutes. If a re-inspection is needed, we’ll get you back on the road quickly once fixes are made.
          </p>
        </div>
      </section>
      ...
      {/* Request a Quote */}
      <section id="uber-inspection-form" className="py-20 px-6 bg-red-600 text-white text-center">
        <h2 className="text-3xl font-bold mb-6">
          Request Your Uber Inspection
        </h2>
        <p className="mb-10">
        ...
        <form className="max-w-3xl mx-auto bg-white text-black p-8 rounded-xl shadow-lg space-y-6 text-left">
          <div>
            ...
            <select
              disabled
              defaultValue="uber-vehicle-inspection"
              className="w-full border border-gray-300 rounded-lg px-4 py-3"
            >
              <option value="uber-vehicle-inspection">
                Uber Vehicle Inspection
              </option>
            </select>
          </div>
