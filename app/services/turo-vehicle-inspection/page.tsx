...
export default function LyftVehicleInspectionPage() {
  ...
  const scenarios = [
    ...
    { icon: FileText, title: "Annual Safety Renewal" },
    { icon: FileText, title: "Post-Incident Re-inspection" },
    { icon: FileText, title: "High-Mileage Vehicle Checks" },
    { icon: FileText, title: "EV & Hybrid Inspections" },
  ];
  ...
  const formItems = [
    {
      ...
      icon: FileText,
      link: null, // add PDF link if available
    },
    {
  ...
  const faqItems = [
    {
      ...
      answer:   "Walk-ins welcome; appointments guarantee fastest service.",
    },
    {
      question: "What documents are required?",
      answer:   "Bring your Lyft inspection form and a valid driver’s license.",
    },
    {
      question: "What if I fail inspection?",
      answer:   "We’ll give you a checklist of fixes—return for a discounted re-inspection.",
    },
    {
    ...
    <main className="bg-white text-black">
      ...
      <section className="bg-gradient-to-b from-red-600 to-red-400 text-white text-center py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold mb-4">Lyft Vehicle Inspection</h1>
      ...
      <section className="bg-gray-100 py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">What Is a Lyft Vehicle Inspection?</h2>
          <p className="text-lg mb-4">
            A comprehensive safety check—lights, brakes, tires, glass, seat belts, mirrors, and more—to meet Lyft’s standards.
          </p>
          <h3 className="text-2xl font-semibold mb-4">When Do You Need It?</h3>
          <ul className="list-disc list-inside text-lg text-gray-700 space-y-2">
            <li>Your car is new to Lyft and needs certification.</li>
      ...
      {/* How It Works */}
      <section className="py-20 px-6 max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-6">How the Inspection Works</h2>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-700">
            Inspections finish in 10–15 minutes; re-inspections in under 10 minutes.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-gray-100">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="mt-6 text-gray-700">
            All fees cover on-site inspection; discounted re-tests available.
          </p>
        </div>
      </section>
      ...
      {/* Request a Quote */}
      <section
        id="lyft-inspection-form"
        className="py-20 px-6 bg-red-600 text-white text-center"
      >
        <h2 className="text-3xl font-bold mb-6">Request Your Lyft Inspection</h2>
        <p className="mb-10">
        ...
        <form className="max-w-3xl mx-auto bg-white text-black p-8 rounded-xl shadow-lg space-y-6 text-left">
          <div>
            ...
            >
              <option value="lyft-vehicle-inspection">Lyft Vehicle Inspection</option>
            </select>
          </div>
